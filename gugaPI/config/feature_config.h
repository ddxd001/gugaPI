...
#ifndef FEATURE_PROFILE_HOST_TEST
#define FEATURE_PROFILE_HOST_TEST (0U)
#endif

#if FEATURE_PROFILE_HOST_TEST
#include "config/feature_host_test_config.h"
#elif FEATURE_PROFILE_COMPETITION
